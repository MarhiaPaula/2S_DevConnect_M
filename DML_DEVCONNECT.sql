...
VALUES
('Marhia Paula','Mapaula','MarhiaPaula@gmail.com','semsenha','www.com.DevConnect/Marhia');

SELECT * FROM tb_usuario;

INSERT INTO  tb_publicacao(descricao,imagem_url,data_publicacao, id_usuario)
VALUES('Flores','www.fotobrasil.com','2025/10/03',1);
...
VALUES('Lindas flores', '2025-10-10',1, 1);
